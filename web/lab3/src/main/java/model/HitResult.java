...
public class HitResult {
  ...
  public HitResult(double x, double y, double r, boolean hit, long exec_micros) {
    this.x = x; this.y = y; this.r = r; this.hit = hit; this.exec_micros = exec_micros;
  }
  ...
  public long getExecMicros() { return exec_micros; }
    ...
    public java.util.Date getCreatedAtDate() {
        return created_at == null ? null :
                java.util.Date.from(created_at.toInstant());
    }
